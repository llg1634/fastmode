...
$releaseNotesSource = Join-Path $repoRoot "release\RELEASE_NOTES_v0.4.0-preview.md"
$releaseNotesRoot = Join-Path $releaseRootFull "RELEASE_NOTES_v0.4.0-preview.md"
...
Copy-Item -LiteralPath (Join-Path $repoRoot "THIRD_PARTY_NOTICES.md") -Destination (Join-Path $packageDir "THIRD_PARTY_NOTICES.md")
...
$versionChecksums = Join-Path $releaseRootFull "SHA256SUMS_v0.4.0-preview.txt"
